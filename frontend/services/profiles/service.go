...
func sourceIDFromStrings(namespace, kindStr, name string) (common.SourceID, error) {
	...
	return common.SourceID{Namespace: namespace, Kind: NormalizeWorkloadKind(kindStr), Name: name}, nil
}
...
// ctx is threaded into the symdb flame-graph build so client disconnects
// cancel the resolver/WriteProfileSymbols work and its temp-dir I/O.

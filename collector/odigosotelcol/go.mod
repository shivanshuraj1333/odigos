...
require (
	...
	go.opentelemetry.io/ebpf-profiler v0.0.202630
...
// local memprof (poller restart/late-init fix + JFR/native) for this build
replace go.opentelemetry.io/ebpf-profiler => github.com/odigos-io/odigos-ebpf-profiler v0.0.202630

replace github.com/grafana/jfr-parser => ../memprof/third_party/jfr-parser

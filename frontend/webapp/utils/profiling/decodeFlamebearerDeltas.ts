 ...
 * offsets — same as `DecodeFlamebearerLevelDeltas` in odigos flamegraph/pyroscope_adapter.go and
 * `deltaDecoding` in github.com/grafana/pyroscope/pkg/model/flamegraph.go.
 */

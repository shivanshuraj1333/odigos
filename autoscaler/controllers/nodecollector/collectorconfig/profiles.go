...
const (
	...
	k8sAttributesProfilesProcessor    = "k8sattributes/profiles"
	otlpProfilesToGatewayExporterName = "otlp/profiles-to-gateway"
)
		...
		Service: config.Service{
			Pipelines: map[string]config.Pipeline{
				"profiles": {
					...
					Processors: []string{k8sAttributesProfilesProcessor},

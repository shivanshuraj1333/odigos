...
// the shared URL-templatization Processor. Uses SyncUrlTemplatizationProcessor(false) so roles are patched
// even when the Processor CR already exists (unlike Action reconcile with fromActionController true).
